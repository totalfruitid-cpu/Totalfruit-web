    ...
    <>
      ...
      <style jsx global>{`
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .navbar-inner{max-width:700px;margin:0 auto;display:flex;justify-content:space-between;align-items:center;padding:15px 20px;position:relative}
      ...
      <nav className="navbar">
        <div className="navbar-inner">
          ...
          <div className="lang-box">
            <span onClick={() => switchLang('id')} className="lang-btn">ID</span>
            <span>/</span>
            <span onClick={() => switchLang('en')} className="lang-btn">EN</span>
          </div>
        </div>
      </nav>
      ...
      <footer>
        ...
        <a href="https://instagram.com/totalfruit.id" target="_blank">@totalfruit.id</a>
        <p>Cibaliung, Pandeglang</p>
        <p>© 2026 TOTAL FRUIT</p>
      </footer>

      <a href="https://wa.me/6285124441513" target="_blank" className="wa-float" style={{background:'#25D366'}}>
        <svg style={{width:'30px',fill:'#fff'}} viewBox="0 0 24 24"><path d="M.057 24l1.687-6.163..." /></svg>
      </a>
    </>
  )
}