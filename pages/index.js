...
export default function Dashboard() {
  ...
  <a href="#menu">MENU</a>
      ...
      {/* Banner Promo TotalGo - DITAMBAHIN DISINI DOANG */}
      <div style={{background:'#FFD700',color:'#000',textAlign:'center',padding:'10px 12px',fontSize:'12px',fontWeight:600,borderBottom:'1px solid #D4AF37',position:'relative',zIndex:999}}>
        Pesan lebih cepat pake app <a href="https://totalgo.vercel.app" style={{color:'#000',textDecoration:'underline',fontWeight:700}}>TotalGo</a> → FRESH. FAST. GOLD.
      </div>
      {/* End Banner */}
